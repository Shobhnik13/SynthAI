  ...
  return (
    <div className="font-bold py-36 text-center space-y-5">
        ...
        <Link href={isSignedIn?'/dashboard':'/sign-up'}>
            <Button  className="bg-gradient-to-r from-indigo-400 via-purple-600 to-pink-600 md:text-lg p-4 md:p-6 mt-2 hover:scale-110 duration-150 transition-all rounded-full font-semibold">Start Exploring!</Button>
        </Link>
